...
> Karega P. et al. (2025). *HPC Co-Design for Africa: Training materials and tools.* Bioinformatics Hub of Kenya (BHKi). GitHub: [https://github.com/karegapauline/BHKi-projects/HPC_project](https://github.com/karegapauline/BHKi-projects/tree/main/HPC_project)
